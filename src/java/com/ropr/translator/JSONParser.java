// $ANTLR 3.1.3 Mar 17, 2009 19:23:44 /development/json-antlr/grammar/JSON.g 2012-07-02 13:28:04
...
public class JSONParser extends Parser {
    ...
    public String getGrammarFileName() { return "/development/json-antlr/grammar/JSON.g"; }
    ...
    // $ANTLR start "value"
    // /development/json-antlr/grammar/JSON.g:49:1: value : ( string | number | object | array | 'true' -> TRUE | 'false' -> FALSE | 'null' -> NULL );
    public final JSONParser.value_return value() throws RecognitionException {
        ...
        try {
            // /development/json-antlr/grammar/JSON.g:50:2: ( string | number | object | array | 'true' -> TRUE | 'false' -> FALSE | 'null' -> NULL )
            int alt1=7;
            switch ( input.LA(1) ) {
            case String:
                {
            ...
            switch (alt1) {
                case 1 :
                    // /development/json-antlr/grammar/JSON.g:50:4: string
                    {
                    ...
                    break;
                case 2 :
                    // /development/json-antlr/grammar/JSON.g:51:4: number
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // /development/json-antlr/grammar/JSON.g:52:4: object
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 4 :
                    // /development/json-antlr/grammar/JSON.g:53:4: array
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 5 :
                    // /development/json-antlr/grammar/JSON.g:54:4: 'true'
                    {
                    ...
                    break;
                case 6 :
                    // /development/json-antlr/grammar/JSON.g:55:4: 'false'
                    {
                    ...
                    break;
                case 7 :
                    // /development/json-antlr/grammar/JSON.g:56:4: 'null'
                    {
    ...
    // $ANTLR start "string"
    // /development/json-antlr/grammar/JSON.g:59:1: string : String -> ^( STRING String ) ;
    public final JSONParser.string_return string() throws RecognitionException {
        ...
        try {
            // /development/json-antlr/grammar/JSON.g:59:9: ( String -> ^( STRING String ) )
            // /development/json-antlr/grammar/JSON.g:59:11: String
            {
            ...
            // 60:4: -> ^( STRING String )
            {
                // /development/json-antlr/grammar/JSON.g:60:7: ^( STRING String )
                {
    ...
    // $ANTLR start "number"
    // /development/json-antlr/grammar/JSON.g:64:1: number : n= Number {...}? ( Exponent )? -> ^( NUMBER Number ( Exponent )? ) ;
    public final JSONParser.number_return number() throws RecognitionException {
        ...
        try {
            // /development/json-antlr/grammar/JSON.g:64:8: (n= Number {...}? ( Exponent )? -> ^( NUMBER Number ( Exponent )? ) )
            // /development/json-antlr/grammar/JSON.g:64:10: n= Number {...}? ( Exponent )?
            {
            ...
            // /development/json-antlr/grammar/JSON.g:65:6: ( Exponent )?
            int alt2=2;
            ...
            {
                // /development/json-antlr/grammar/JSON.g:66:7: ^( NUMBER Number ( Exponent )? )
                {
                Object root_1 = (Object)adaptor.nil();
                root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(NUMBER, "NUMBER"), root_1);

                adaptor.addChild(root_1, stream_Number.nextNode());
                // /development/json-antlr/grammar/JSON.g:66:23: ( Exponent )?
    ...
    // $ANTLR start "object"
    // /development/json-antlr/grammar/JSON.g:69:1: object : '{' ( members )? '}' -> ^( OBJECT ( members )? ) ;
    public final JSONParser.object_return object() throws RecognitionException {
        ...
        try {
            // /development/json-antlr/grammar/JSON.g:69:8: ( '{' ( members )? '}' -> ^( OBJECT ( members )? ) )
            // /development/json-antlr/grammar/JSON.g:69:10: '{' ( members )? '}'
            {
            char_literal10=(Token)match(input,24,FOLLOW_24_in_object209);  
            stream_24.add(char_literal10);

            // /development/json-antlr/grammar/JSON.g:69:14: ( members )?
            int alt3=2;
            ...
            // 70:4: -> ^( OBJECT ( members )? )
            {
                // /development/json-antlr/grammar/JSON.g:70:7: ^( OBJECT ( members )? )
                {
                Object root_1 = (Object)adaptor.nil();
                root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(OBJECT, "OBJECT"), root_1);

                // /development/json-antlr/grammar/JSON.g:70:16: ( members )?
    ...
    // $ANTLR start "array"
    // /development/json-antlr/grammar/JSON.g:73:1: array : '[' ( elements )? ']' -> ^( ARRAY ( elements )? ) ;
    public final JSONParser.array_return array() throws RecognitionException {
        ...
        try {
            // /development/json-antlr/grammar/JSON.g:73:7: ( '[' ( elements )? ']' -> ^( ARRAY ( elements )? ) )
            // /development/json-antlr/grammar/JSON.g:73:9: '[' ( elements )? ']'
            {
            char_literal13=(Token)match(input,26,FOLLOW_26_in_array238);  
            stream_26.add(char_literal13);

            // /development/json-antlr/grammar/JSON.g:73:13: ( elements )?
            int alt4=2;
            int LA4_0 = input.LA(1);

            if ( ((LA4_0>=String && LA4_0<=Number)||(LA4_0>=21 && LA4_0<=24)||LA4_0==26) ) {
                alt4=1;
            }
            switch (alt4) {
                case 1 :
            ...
            char_literal15=(Token)match(input,27,FOLLOW_27_in_array243);  
            ...
            // 74:4: -> ^( ARRAY ( elements )? )
            {
                // /development/json-antlr/grammar/JSON.g:74:7: ^( ARRAY ( elements )? )
                {
                Object root_1 = (Object)adaptor.nil();
                root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(ARRAY, "ARRAY"), root_1);

                // /development/json-antlr/grammar/JSON.g:74:15: ( elements )?
    ...
    // /development/json-antlr/grammar/JSON.g:77:1: elements : value ( COMMA value )* ;
    public final JSONParser.elements_return elements() throws RecognitionException {
        ...
        try {
            // /development/json-antlr/grammar/JSON.g:77:9: ( value ( COMMA value )* )
            // /development/json-antlr/grammar/JSON.g:77:11: value ( COMMA value )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            // /development/json-antlr/grammar/JSON.g:77:17: ( COMMA value )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // /development/json-antlr/grammar/JSON.g:77:18: COMMA value
            	    {
    ...
    // $ANTLR start "members"
    // /development/json-antlr/grammar/JSON.g:80:1: members : pair ( COMMA pair )* ;
    public final JSONParser.members_return members() throws RecognitionException {
        ...
        try {
            // /development/json-antlr/grammar/JSON.g:80:9: ( pair ( COMMA pair )* )
            // /development/json-antlr/grammar/JSON.g:80:11: pair ( COMMA pair )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            // /development/json-antlr/grammar/JSON.g:80:16: ( COMMA pair )*
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // /development/json-antlr/grammar/JSON.g:80:17: COMMA pair
            	    {
    ...
    // $ANTLR start "pair"
    // /development/json-antlr/grammar/JSON.g:83:1: pair : String ':' value -> ^( FIELD String value ) ;
    public final JSONParser.pair_return pair() throws RecognitionException {
        ...
        try {
            // /development/json-antlr/grammar/JSON.g:83:6: ( String ':' value -> ^( FIELD String value ) )
            // /development/json-antlr/grammar/JSON.g:83:8: String ':' value
            {
            String22=(Token)match(input,String,FOLLOW_String_in_pair303);  
            stream_String.add(String22);

            char_literal23=(Token)match(input,28,FOLLOW_28_in_pair305);  
            ...
            {
                // /development/json-antlr/grammar/JSON.g:84:7: ^( FIELD String value )
                {
                Object root_1 = (Object)adaptor.nil();
    ...
    public static final BitSet FOLLOW_26_in_array238 = new BitSet(new long[]{0x000000000DE06000L});
    public static final BitSet FOLLOW_elements_in_array240 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_27_in_array243 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_elements264 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_COMMA_in_elements267 = new BitSet(new long[]{0x0000000005E06000L});
    public static final BitSet FOLLOW_value_in_elements270 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_pair_in_members283 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_COMMA_in_members286 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_pair_in_members289 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_String_in_pair303 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_28_in_pair305 = new BitSet(new long[]{0x0000000005E06000L});
